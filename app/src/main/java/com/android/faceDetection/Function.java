...
public class Function {
    ...
    static final String KEY_PICASA_ID = "picasa_id";
    ...
    public static HashMap<String, String> mappingInbox(String album, String path, String timestamp, String time, String count, String id, String picasa_id)
    {
        ...
        map.put(KEY_ID, id);
        map.put(KEY_PICASA_ID,picasa_id);
        return map;
    }
